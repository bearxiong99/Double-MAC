...
#define TRAFFIC_MODEL  // 0: Periodic, 1: Poisson
#if TRAFFIC_MODEL == 0
#define PERIOD 
#elif TRAFFIC_MODEL == 1
#define ARRIVAL_RATE  // Mean value, 1/lambda
#endif
